...
public interface Organization {
     ...
     */
    void addContractEmployee(String name, double salary, Gender gender, int endYear, int endMonth,
                             int endDate, String supervisorName);
    ...
    /**
     * Return the number of employees who are scheduled to be terminated before a specific date.
